...
<head>
    ...
    <title>فروشگاه آنلاین نکستژن - پرداخت موفق</title>
    <!-- Bootstrap 5 RTL CSS -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="payment-result">
                    ...
                    <p class="mb-4">از خرید شما سپاسگزاریم. سفارش شما با موفقیت ثبت شد و در اسرع وقت برای شما ارسال خواهد شد.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-header">اطلاعات ارسال</div>
                                <div class="card-body">
                                    <div class="order-item">
                                        <div>نام تحویل گیرنده:</div>
                                        <div>علی محمدی</div>
                                    </div>
                                    <div class="order-item">
                                        <div>آدرس:</div>
                    ...
                    <div class="order-details mt-4">
                        <h4 class="mb-3">جزئیات سفارش</h4>
                        <div class="order-item">
                            <div>هودی راحت (سایز M، رنگ مشکی)</div>
                            <div>24,000 تومان</div>
                        </div>
                        <div class="order-item">
                            <div>کفش ورزشی (سایز 42، رنگ سفید)</div>
                            <div>35,000 تومان</div>
                        </div>
                        <div class="order-item">
                            <div>تیشرت ساده (سایز L، رنگ آبی)</div>
                    ...
                    <h4 class="mt-5 mb-4">مراحل سفارش شما</h4>
                    <div class="progress-track">
                        <div class="progress-step completed">
                            <div class="progress-icon">
                                <i class="bi bi-check-lg"></i>
                            </div>
                            <div class="progress-label">ثبت سفارش</div>
                        </div>
                        <div class="progress-step completed">
                            <div class="progress-icon">
                                <i class="bi bi-check-lg"></i>
                            </div>
                            <div class="progress-label">پرداخت</div>
                        </div>
                        <div class="progress-step active">
                            <div class="progress-icon">
                                <i class="bi bi-box-seam"></i>
                            </div>
                            <div class="progress-label">آماده‌سازی</div>
                        </div>
                        <div class="progress-step">
                            <div class="progress-icon">
                                <i class="bi bi-truck"></i>
                            </div>
                            <div class="progress-label">ارسال</div>
                        </div>
                        <div class="progress-step">
                            <div class="progress-icon">
                                <i class="bi bi-house-check"></i>
                            </div>
                            <div class="progress-label">تحویل</div>
                        </div>
                    </div>
                    
                    <div class="mt-4">
                        <p class="mb-3">ایمیلی حاوی اطلاعات سفارش به آدرس <strong>user@example.com</strong> ارسال شد.</p>
                        <p>می‌توانید با کد رهگیری <span class="tracking-number">NXG-10057834</span> از وضعیت سفارش خود مطلع شوید.</p>
                    </div>
                    
                    <div class="mt-4">
                        <a href="index.php" class="btn btn-outline-dark me-2">بازگشت به صفحه اصلی</a>
                        <a href="products.php" class="btn btn-outline-success">ادامه خرید</a>
                    </div>
                </div>
            </div>
        </div>
